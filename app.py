...
def page_data_overview():
    ...
    with tab2:
        ...
        with col_b:
            ...
            ax.hist([ham_lengths, spam_lengths], bins=30, label=['Ham', 'Spam'],
    ...
    try:
        ...
        with tab1:
            ...
            with col1:
                ...
                ax.bar(x - width/2, df_metrics['Accuracy'], width, label='Accuracy', color='#3498db')
                ax.bar(x + width/2, df_metrics['F1-Score'], width, label='F1-Score', color='#e74c3c')
            ...
            with col2:
                ...
                ax.scatter(df_metrics['Recall'], df_metrics['Precision'], 
                          s=200, c=range(len(df_metrics)), cmap='viridis', alpha=0.7, edgecolors='black')
...
def page_feature_analysis():
    ...
    with tab1:
        ...
        with col1:
            ...
            ax.barh(range(len(ham_df)), ham_df['Frequency'], color='#2ecc71', edgecolor='black')
        ...
        with col2:
            ...
            fig, ax = plt.subplots(figsize=(8, 10))
            ax.barh(range(len(spam_df)), spam_df['Frequency'], color='#e74c3c', edgecolor='black')
    ...
    with tab3:
        ...
        with col1:
            ...
            if ham_bigrams:
                ...
                ax.barh(range(len(bigram_df)), bigram_df['Frequency'], color='#2ecc71', edgecolor='black')
        ...
        with col2:
            ...
            if spam_bigrams:
                ...
                fig, ax = plt.subplots(figsize=(8, 8))
                ax.barh(range(len(bigram_df)), bigram_df['Frequency'], color='#e74c3c', edgecolor='black')
                ax.set_yticks(range(len(bigram_df)))
                ax.set_yticklabels(bigram_df['Bigram'], fontsize=9)
                ax.invert_yaxis()
                ax.set_xlabel('Frequency', fontsize=12)
